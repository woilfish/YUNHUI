...
import com.yunhui.component.slidingmenu.SlidingMenu;
...
public class StatusBarUtil {
     ...
     * @param color    状态栏颜色值
     */
    public static void setColorWithDark(Activity activity, int color, boolean isDark) {
    ...
    public static void setTransparentForSlidingMenu(Activity activity, SlidingMenu slidingMenu) {
        ...
        ViewGroup contentLayout = (ViewGroup) slidingMenu.getChildAt(0);
        // 内容布局不是 LinearLayout 时,设置padding top
        if (!(contentLayout instanceof LinearLayout) && contentLayout.getChildAt(1) != null) {
            contentLayout.getChildAt(1).setPadding(0, getStatusBarHeight(activity), 0, 0);
        }
        ...
        // 设置属性
        ViewGroup drawer = (ViewGroup) slidingMenu.getChildAt(1);
