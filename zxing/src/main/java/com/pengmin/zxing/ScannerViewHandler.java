...
import com.pengmin.zxing.decode.DecodeThread;
...
final class ScannerViewHandler extends Handler {
    ...
    ScannerViewHandler(ScannerView scannerView, Collection<BarcodeFormat> decodeFormats,
        ...
        //启动扫描线程
        decodeThread = new DecodeThread(cameraManager, this, decodeFormats, scannerView.getScannerOptions().isCreateQrThumbnail());
